...
title="Training architecture depicting triplet loss" width="800px" style="max-width: 100%; height: auto;"/></div>
...
title="Inference architecture" width="800px" style="max-width: 100%; height: auto;"/></div>
...
title="Swapping noise on images from notMNIST dataset" width="800px" style="max-width: 100%; height: auto;"/></div>
...
title="Removing structural noise from Places dataset images" width="800px" style="max-width: 100%; height: auto;"/></div>

<figure class="half" style="display: flex; justify-content: center; gap: 10px;">
    <a href="/assets/images/CL_CIFAR10.png"><img src="/assets/images/CL_CIFAR10.png" width="400px" style="max-width: 100%; height: auto;"></a>
    <a href="/assets/images/CL_CIFAR10_2.png"><img src="/assets/images/CL_CIFAR10_2.png" width="400px" style="max-width: 100%; height: auto;"></a>
</figure>
